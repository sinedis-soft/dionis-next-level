...
const kz: AboutDictionary = {
  ...
  legal: {
    ...
    body: [
      ...
      "",
      "Кәсіби жауапкершілікті ерікті сақтандыру шарты №444-26-987-0000026, 12.01.2026 ж.",
...
const en: AboutDictionary = {
  ...
  legal: {
    ...
    body: [
      ...
      "",
      "Professional liability insurance contract No. 444-26-987-0000026 dated 12 January 2026.",
      ...
      "2) bodily injury.",
      "",
      "Policy period: from 16 January 2026 to 15 January 2027.",
