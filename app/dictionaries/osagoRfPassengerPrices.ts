...
export type OsagoRfPassengerPricesDictionary = {
  ...
  cards: {
    title: string; subtitle: string; individual: string; multidrive: string; electronicPolicy: string; cta: string; rubApprox: string; kztPending: string;
...
const en: OsagoRfPassengerPricesDictionary = {
  ...
  cards: { title: "Estimated prices by engine power", subtitle: "Each group shows 15 days, 1 month and 12 months. The KZT price is calculated using the NBK RUB/KZT rate.", individual: "Individual", multidrive: "No driver limit", electronicPolicy: "The electronic policy is provided after document verification.", cta: "Apply", rubApprox: "RUB estimate", kztPending: "KZT cost is being confirmed", terms: { d15: "15 days", m1: "1 month", m12: "12 months" }, ranges: { hp70_99: "70 to 99 HP", hp100_119: "100 to 119 HP", hp120_150: "120 to 150 HP", hp150plus: "Over 150 HP" } },
