...
const ru: OsagoRfPassengerPricesDictionary = {
  seo: { title: "Стоимость ОСАГО России для легкового авто из Казахстана | DIONIS", description: "Стоимость ОСАГО РФ для легковых автомобилей физических лиц. Цены на 15 дней, 1 месяц и год, точный расчёт и онлайн-заявка.", breadcrumbs: { home: "Главная", osago: "ОСАГО РФ", current: "Стоимость для легковых авто" } },
