...
export async function GET(
  ...
  const channelTitle =
    lang === "ru" ? "Dionis — Блог" : lang === "kz" ? "Dionis — Blog (KZ)" : "Dionis — Blog (EN)";
...
<rss version="2.0">
  <channel>
    ...
    <description>${escapeXml("Статьи о страховании: авто, грузы, кейсы и практические разборы.")}</description>
