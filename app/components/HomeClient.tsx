  ...
  return (
    <>
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-center">
              ...
              {t.benefits.cards.map((card, idx) => (
                ...
                >
                  {/* Иконки оставил как было у вас: можно вернуть ваши svg по idx */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] gap-10 items-center">
              <div>
                ...
                >
                  ...
                  <span className="text-[#C89F4A]">{t.broker.titleHighlight}</span>
                  <br />
      ...
      <AgreementModal
        ...
        // Важно: при "Принять" — просто закрываем. Галочку ставит форма через свой setAgreeFromOutside
      />
    </>
  );
}
